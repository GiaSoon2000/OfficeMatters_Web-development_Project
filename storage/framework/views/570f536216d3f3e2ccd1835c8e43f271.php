...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <form action="<?php echo e(route('updateProduct')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <input class="form-control" type="number" id="productPrice" name="productPrice" min="0" step="0.01" required value="<?php echo e($product->price); ?>">
            </div>
            <div class="form-group">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ricky\Web_Project1\resources\views/editProduct.blade.php ENDPATH**/ ?>