    ...
    <div class="container" id="header-content">
      ...
      <div class="collapse navbar-collapse" id="navbarNav" style="background-color: #F8F9FA;">
        <ul class="navbar-nav ml-auto" id="navigation">
          ...
          <li class="nav-item dropdown hover-dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="shopDropdown">
              <a class="dropdown-item" href="<?php echo e(route('notebooks')); ?>">Notebooks</a>
              <a class="dropdown-item" href="<?php echo e(route('pens')); ?>">Pens & Pencils</a>
              <a class="dropdown-item" href="<?php echo e(route('deskAccessories')); ?>">Desk Accessories</a>
            </div>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav ml-auto" id="auth-navigation">
          <!-- <li class="nav-item">
            <a id="loginLink" class="nav-link" href="<?php echo e(route('login')); ?>"><i class="fas fa-user"></i> Log in</a>
          </li> -->
          ...
          <li class="nav-item">
          <a id="cartLink" class="nav-link" href="<?php echo e(route('myCart')); ?>">
              <i class="fas fa-shopping-cart"></i> Cart 
              <?php if(Session::has('cartItem') && Session::get('cartItem') > 0): ?>
                  <span class="badge badge-pill badge-danger"><?php echo e(Session::get('cartItem')); ?></span>
              <?php endif; ?>
          </a>
        </li>
      </ul>
...
</html><?php /**PATH C:\Users\Ricky\Web_Project1\resources\views/layout.blade.php ENDPATH**/ ?>