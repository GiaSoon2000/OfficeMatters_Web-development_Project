...
<div class="container mt-5">
    ...
    <div class="row mt-5">
      <div class="col-md-10 offset-md-1">
        ...
        <p>Please contact our admin if you need us to ship internationally. <a href="<?php echo e(route('contact')); ?>">Contact Us.</a></p>
        ...
        <p>All items are non-returnable once sold. Unless it’s a damaged/low-quality item, but need to be reported to customer service within 3 days after receiving. <a href="<?php echo e(route('contact')); ?>">Contact Us</a>. All returned items must be in original condition.</p>
        ...
        <p><strong>Still got questions?<a href="<?php echo e(route('contact')); ?>">Contact Us.</a></strong> </p> 
    </div>
    </div>
  </div>
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ricky\Web_Project1\resources\views/FAQ.blade.php ENDPATH**/ ?>